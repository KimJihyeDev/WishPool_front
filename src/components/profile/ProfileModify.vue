					...
					<form>
						<div class="row">
                            ...
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
								<div id="photo-box">
                                    <svg class="olymp-camera-icon" style="margin-right: .7rem;">
                                        <use xlink:href="/assets/svg-icons/sprites/icons.svg#olymp-camera-icon"></use></svg>
                                    프로필 사진 수정하기
                                </div>
